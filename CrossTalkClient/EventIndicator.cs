...
namespace CrossTalkClient
{
	public class EventIndicator : Control
	{
		...
		readonly Brush AmberDim = new SolidBrush(Color.FromArgb(255, 64, 50, 32));
		readonly Brush AmberLit = new SolidBrush(Color.FromArgb(255, 255, 200, 32));
		readonly Brush RedDim = new SolidBrush(Color.FromArgb(255, 64, 32, 32));
		readonly Brush RedLit = new SolidBrush(Color.FromArgb(255, 255, 32, 32));
		readonly Brush GreenDim = new SolidBrush(Color.FromArgb(255, 32, 64, 32));
		readonly Brush GreenLit = new SolidBrush(Color.FromArgb(255, 32, 255, 32));
		readonly Brush BlueDim = new SolidBrush(Color.FromArgb(255, 32, 32, 64));
